# national_park_prediction

This repository is for predicting the number of accumdation in national park
...
Most of the source codes of this project, `national_park_prediction` are stored in the `national_park_prediction` directory.
...
`make create-container` creates and launch the national_park_prediction container.
